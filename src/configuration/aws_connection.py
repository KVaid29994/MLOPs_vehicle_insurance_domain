...
class S3Client:
    '''The S3Client class initializes 
    and maintains a singleton-style connection to AWS S3 using the boto3 library.'''
    ...
    def __init__(self, region_name=REGION_NAME):
        ...
        It creates boto3.resource and boto3.client objects for interacting with S3.
        """
